...
//		    driver.findElement(By.xpath("//button[@id='resendEmailBtn']")).click();
//		    driver.findElement(By.cssSelector("#resendEmailBtn")).click();

// not working		    driver.manage().timeouts().implicitlyWait(300, TimeUnit.SECONDS);
			try {
